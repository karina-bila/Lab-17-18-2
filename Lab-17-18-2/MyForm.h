...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(184, 36);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Bookman Old Style", 14.25F, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label2->Location = System::Drawing::Point(186, 78);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(314, 39);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(314, 78);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(223, 161);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(364, 161);
			...
			this->pictureBox1->Size = System::Drawing::Size(138, 149);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		form2->ShowDialog();
		if (textBox1->Text == "") {
			MessageBox::Show("Beeдirь Username !!", "COM", MessageBoxButtons::OK, MessageBoxIcon::Warning);
		}
		else if (textBox2->Text == "") {
			MessageBox::Show("Beeдiть пароль !!", "Увага!!!", MessageBoxButtons::OK, MessageBoxIcon::Warning);
		}
			...
			MessageBox::Show("Heправильний napoль", "Увагa!!!", MessageBoxButtons::OK, MessageBoxIcon::Error);
		}
	}
